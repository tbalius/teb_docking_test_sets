...
set workdir = ${mountdir}/db2_bulid_from_smi/
...
# cat db2_bulid_from_smi/db_build_working/${ligname}/${ligname}_0_output.mol2 >> lig_solv.mol2
# echo "@<TRIPOS>SOLVATION" >> lig_solv.mol2
# #cat output.solv >> lig_solv.mol2
# cat db2_bulid_from_smi/db_build_working/${ligname}/${ligname}_0_output.solv >> lig_solv.mol2
