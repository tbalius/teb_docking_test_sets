...
def assign_decoys_to_ligands(decfilelines,N_lig,lignames,fmatched,maxdecoys):
...
def main():
  ...
  ligdict = assign_decoys_to_ligands(decfilelines,N_lig,lignames,fmatched,maxdecoys)
